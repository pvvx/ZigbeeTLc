...
python3 make\zb_bin_ota.py bin\ZYZTH02%SWVER%.bin bin\ZYZTH02z%SWVER% -m0x1002 -i0x0203 -v0x66993001 -s"Tuya to ZigbeeTlc"
python3 make\zb_bin_ota.py bin\ZG227Z%SWVER%.bin bin\ZG227Zz%SWVER% -m0x1286 -i0x0203 -v0x10983001 -s"Tuya to ZigbeeTlc"
@exit
:error
echo "Error!"
