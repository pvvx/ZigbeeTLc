...
make -s -j clean
make -s -j VERSION_BIN=%SWVER% PROJECT_NAME=Z06MMC POJECT_DEF="-DBOARD=BOARD_MJWSD06MMC"
...
python3 make_z\zb_bin_ota.py bin\ZBTH01%SWVER%.bin bin\ZBTH01z%SWVER% -m0x1286 -i0x0202 -v0x10933607 -s"Tuya to ZigbeeTlc"
cd .\zigpy_ota
