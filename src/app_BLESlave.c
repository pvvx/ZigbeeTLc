...
#error "DEVICE_TYPE = ?"
		...
		tbl_scanRsp.name[6] = '-';
		tbl_scanRsp.name[7] = tab_hex_ascii[mac_public[2] >> 4];
		tbl_scanRsp.name[8] = tab_hex_ascii[mac_public[2] & 0x0f];
		tbl_scanRsp.name[9] = tab_hex_ascii[mac_public[1] >> 4];
		tbl_scanRsp.name[10] = tab_hex_ascii[mac_public[1] & 0x0f];
		tbl_scanRsp.name[11] = tab_hex_ascii[mac_public[0] >> 4];
		tbl_scanRsp.name[12] = tab_hex_ascii[mac_public[0] & 0x0f];
